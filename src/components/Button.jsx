...
const Button = ({ children, onClick, variant = 'primary', className = '', ...props }) => {
    const variants = {
        ...
        outline: 'border-2 border-royal-maroon-900 text-royal-maroon-900 dark:bg-royal-maroon-900 dark:text-white dark:border-royal-maroon-900 hover:bg-royal-maroon-900 hover:text-white shadow-sm',
