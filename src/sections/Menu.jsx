...
const Menu = () => {
    ...
    return (
        <section id="menu" className="py-32 bg-mesh">
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-20">
                    {MENU_CATEGORIES.slice(0, 8).map((cat) => (
                        <button
                            ...
                            className={`px-8 py-3 rounded-full text-xs font-black tracking-widest uppercase transition-all duration-500 transform hover:-translate-y-1 ${activeCategory === cat
